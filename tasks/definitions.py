...
TASK_METADATA = [
    {
        ...
        "difficulty": "easy",
        "has_grader": True,
        "grader": "llmfleet_sre.server.graders.easy_grader",
    ...
    },
    {
        ...
        "difficulty": "medium",
        "has_grader": True,
        "grader": "llmfleet_sre.server.graders.medium_grader",
    ...
    },
    {
        ...
        "difficulty": "hard",
        "has_grader": True,
        "grader": "llmfleet_sre.server.graders.hard_grader",
    ...
    },
    {
        ...
        "difficulty": "hard",
        "has_grader": True,
        "grader": "llmfleet_sre.server.graders.loghaul_grader",
        "ideal_action": "route_batch",
        "steps": 50,
